---
description: How to cite Sklearn-Wrap, in plain text and in BibTeX.
---
...
The version you used is the one `pip show sklearn_wrap` reports.

## Machine-readable metadata

The repository root carries a
[`CITATION.cff`](https://github.com/stateful-y/sklearn-wrap/blob/main/CITATION.cff)
...
No release of Sklearn-Wrap has been deposited with a DOI-issuing archive, so
